...
<tr><td style={{textAlign: 'left'}}>Center</td><td style={{textAlign: 'right'}}>+0.027</td><td style={{textAlign: 'right'}}>+0.050</td><td style={{textAlign: 'right'}}>+0.095</td><td style={{textAlign: 'right'}}>+0.184</td></tr>
<tr><td style={{textAlign: 'left'}}>Edge</td><td style={{textAlign: 'right'}}>+0.028</td><td style={{textAlign: 'right'}}>+0.054</td><td style={{textAlign: 'right'}}>+0.096</td><td style={{textAlign: 'right'}}>+0.166</td></tr>
</tbody>
</table>
