...
2. For logical monotonic functions, the truth of each conclusion is invariant in the face of additional input.
</details>
...
<div style={{
  ...
  <img src="/img/ferrari-diagonal.svg" alt="CRDT Ferrari Sequence Diagram" style={{ width: "85%", display: "block" }} />
</div>
...
<div style={{
  ...
  <img src="/img/ingredients.svg" alt="CRDT Ingredient Sequence Diagram" style={{ width: "100%", display: "block" }} />
</div>
You might be saying:
